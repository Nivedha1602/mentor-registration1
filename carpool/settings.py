...
SECRET_KEY = 'django-insecure-dc#3b6*d7xn80+bw4zv+3-&md+7ue(7#q0fw-a8isn+k)$#ni9'
...
CSRF_TRUSTED_ORIGINS = [
    'https://yourdomain.com',          # Your own domain
    'http://localhost:8000',           # For local development
    'http://127.0.0.1:8000',           # For local development
    'https://api.razorpay.com',        # Razorpay API domain
    'https://checkout.razorpay.com',   # Razorpay checkout domain
]
